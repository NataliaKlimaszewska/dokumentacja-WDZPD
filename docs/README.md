...
| --- |----------------|----------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Maksym Wilk | 1(2)           |Lider<br><br> Projekt Manager<br><br>Programista backend<br><br>DevOps | Rozdzielanie zadań, koordynowanie działań zespołu, kontakt z prowadzącym zajęcia,implementacja logiki biznesowej, baza danych, API, system logowania akcji użytkowników, organizowanie spotkań, uwierzytelnianie użytkowników, deployment                                                                       |
